...
if CLIENT then
    SWEP.PrintName = "Admin Abuse" -- The name that shows in the scroll menu and when you hover over the gun in the q-menu.
...
SWEP.Spawnable = false -- If the weapon can be spawned.
...
SWEP.WorldModel = "" -- The point of view others have when looking at the player holding the gun.
...
SWEP.HoldType = "normal" -- This is how others view you carrying the weapon. Options include:
...
SWEP.Primary.Recoil = 0 -- How much the gun will jump while shooting.
SWEP.Primary.Damage = 5 -- How much it will hurt every time a bullet hits its target.
SWEP.Primary.NumShots = 10 -- How many bullets come out every time you shoot. Anything higer than 1 would probably be a shotgun.
SWEP.Primary.Cone = 0 -- How accurate the gun will be. Think "CSGO" when it comes to the weapon spread, thats this.
SWEP.Primary.ClipSize = 999999999 -- How much ammo can you hold in the clip at one time.
SWEP.Primary.Delay = 0.03 -- A delay between shots. Effects fire speed.
SWEP.Primary.DefaultClip = 999999999 -- How much ammo you spawn with.
